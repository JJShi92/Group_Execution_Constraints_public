...
def main(argv):
    ...
    for util in range(5, 55, 5):
        ...
        makespan_all.append(graph.calculate_longest_path_all(tasksets))

    results_name = './outputs/makespan_cp_m' + str(msets) + '_p' + str(processors) + '_q' + str(pc_prob)+ '_s' + str(sparse)+ '_g' + str(group_mode)+ '_r' + str(group_prob)+'.npy'
