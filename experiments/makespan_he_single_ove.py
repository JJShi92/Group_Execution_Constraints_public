...
def main(argv):
    ...
    scale = 10**6
    try:
        opts, args = getopt.getopt(argv, "hm:p:q:s:g:r:u:o:",
                                   ["msets=", "processors", "pc_prob=", "sparse=", "gpm=", "gpq=", "util", "ove"])
    ...
    results_name = './outputs2/makespan_he_m' + str(msets) + '_p' + str(processors) + '_u' + str(util) + '_q' + str(pc_prob)+ '_s' + str(sparse) + '_g' + str(group_mode) + '_r' + str(group_prob) + '_o' + str(over)+'.npy'
