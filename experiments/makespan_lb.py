...
from algorithms import Optimal as lb
...
def main(argv):
    ...
    for util in range(5, 55, 5):
        ...
        makespan_all.append(lb.calculate_makespan_all(tasksets, processors))

    results_name = './outputs/makespan_lb_m' + str(msets) + '_p' + str(processors) + '_q' + str(pc_prob)+ '_s' + str(sparse)+ '_g' + str(group_mode)+ '_r' + str(group_prob)+'.npy'
